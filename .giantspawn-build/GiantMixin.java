...
public class GiantMixin extends Mob {
    ...
    protected void addBehaviourGoals(Giant giant) {
        ...
        // Restore the village-traversal goal used by vanilla Zombie. Giants do
        // not expose Zombie's private door-breaking state, so door breaking is
        // deliberately disabled while the normal village pathing remains.
        this.goalSelector.addGoal(6, new MoveThroughVillageGoal(giant, 1.0D, true, 4, () -> false));
