 ...
 *
 * ZombieAttackGoal itself requires a Zombie instance, so a Giant cannot use it
...
public class GiantAttackGoal extends MeleeAttackGoal {
    ...
    public void tick() {
        ...
        // Match vanilla ZombieAttackGoal: consult MeleeAttackGoal's actual
        // cooldown instead of a disconnected field that never changes.
