...
public final class SculkCatalystBlindnessGameTest implements FabricGameTest {
    ...
    public void sculkCatalystAreaBlindnessSkipsPlayerBystandersButHitsDirectPlayer(final GameTestHelper helper) {
        ...
        // These assertions exercise the exact predicate called by the production AREA
        // loop. A player bystander is rejected, the exact directly attacked player is
        // accepted by object identity, another player remains rejected, and non-player
        // living entities remain accepted.
...
''')
print('Injected robust Sculk Catalyst player-bystander blindness GameTest v2.')
